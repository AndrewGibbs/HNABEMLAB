...
%         domain
    ...
    methods
        ...
        function K = kernelNonOscAnal(self,s,t,sGEt, sSide, tSide)
            ...
            if nargin == 6
                K = self.coupling_param/4 * besselh(0,1,self.kwave*self.domain.distAnal(s,t,0,sGEt, sSide, tSide))./exp(1i*self.kwave*self.domain.distAnal(s,t,0,sGEt, sSide, tSide));
            else
